        ...
        return FileDownloader.getImpl().create(mDownLoadUrl)
                ...
                .setListener(new FileDownloadSampleListener() {
                    ...
                    protected void completed(BaseDownloadTask task) {
                        ...
                        if (mListener != null && !TextUtils.isEmpty(mApkPath))
                            mListener.completed(mApkPath);
                        Log.e(TAG, "completed==" + mApkPath);
                        Toast.makeText(mContext, "下载完成", Toast.LENGTH_SHORT).show();
                        //下载完成删除这个任务
                        FileDownloader.getImpl().clear(downloadId, mDownLoadUrl);
                        DownloadNotifyUtil.getInstance().hideDownloadProgress();
//                        final String appid = "com.yctc.zhiting.provider";
//                        AndroidUtil.installApk((Activity) mContext, appid, mApkPath);
                    }
