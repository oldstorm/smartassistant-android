...
public class QRCodeParseUtils {
     ...
     * @param path
     */
    public static void parsePhoto(Activity activity, String path, OnImageParseListener listener) {
        //启动线程完成图片扫码
        new QrCodeAsyncTask(activity, path, listener).execute(path);
    }
    ...
    private static class QrCodeAsyncTask extends AsyncTask<String, Integer, String> {
        ...
        private String path;
        private OnImageParseListener mListener;

        public QrCodeAsyncTask(Activity activity, String path, OnImageParseListener listener) {
    ...
    public interface OnImageParseListener {
