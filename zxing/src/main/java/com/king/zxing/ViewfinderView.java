...
public class ViewfinderView extends View {
    ...
    private void drawCorner(Canvas canvas, Rect frame) {
        ...
        int offset = cornerRectWidth + frameLineWidth;
        //左上竖
        canvas.drawRect(frame.left - offset, frame.top - offset, frame.left, frame.top + cornerRectHeight, paint);
        //左上横
        ...
        //右上竖
        canvas.drawRect(frame.right, frame.top, frame.right + offset, frame.top + cornerRectHeight, paint);
        //右上横
        canvas.drawRect(frame.right - cornerRectHeight, frame.top - offset, frame.right + offset, frame.top, paint);
        //右下竖
        canvas.drawRect(frame.right, frame.bottom - cornerRectHeight, frame.right + offset, frame.bottom + offset, paint);
        //右下横
        canvas.drawRect(frame.right - cornerRectHeight, frame.bottom, frame.right + offset, frame.bottom + offset, paint);
    }
