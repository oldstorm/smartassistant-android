...
public class UCropActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        rbPerform = findViewById(R.id.rbPerform);
    ...
    private void showProgress(boolean show) {
        tvFinish.setVisibility(show ? View.GONE : View.VISIBLE);
        rbPerform.setVisibility(show ? View.VISIBLE : View.GONE);
    }
    ...
    private void processOptions(@NonNull Intent intent) {
        ...
        mOverlayView.setCropGridCornerColor(intent.getIntExtra(UCrop.Options.EXTRA_CROP_GRID_CORNER_COLOR, getResources().getColor(R.color.ucrop_color_white)));
