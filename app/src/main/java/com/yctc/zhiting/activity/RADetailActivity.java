...
public class RADetailActivity extends MVPBaseActivity<RADetailContract.View, RADetailPresenter> implements RADetailContract.View{
    ...
    protected void initUI() {
        ...
        tvName.setText(name);
        System.out.println("房间id："+raId);
        equipmentAdapter = new EquipmentAdapter();

        equipmentAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            @Override
    ...
    private void updateRoomName(){
        ...
        editBottomDialog.setClickSaveListener(new EditBottomDialog.OnClickSaveListener() {
            @Override
