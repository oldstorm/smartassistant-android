...
import com.yctc.zhiting.activity.model.AddCompanyModel;
 ...
 * 添加家庭/公司等区域
 */
public class AddCompanyPresenter extends BasePresenterImpl<AddCompanyContract.View> implements AddCompanyContract.Presenter {

    private AddCompanyModel model;
