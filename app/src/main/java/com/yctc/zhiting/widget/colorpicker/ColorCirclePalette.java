...
public class ColorCirclePalette extends View {
    ...
    public ColorCirclePalette(Context context) {
        this(context, null);
    }

    public ColorCirclePalette(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ColorCirclePalette(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
